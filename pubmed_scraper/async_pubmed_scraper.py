...
def parse_args(args):
    ...
    parser.add_argument('--start', type=int, default=2019, help='Specify start year for publication date range.')
    parser.add_argument('--stop', type=int, default=2020, help='Specify stop year for publication date range.')
    parser.add_argument('--output', type=str, default='articles.csv', help='Choose output file name.')
    parser.add_argument('--keywords', type=str, required=True, help='Comma-separated list of keywords to search for.')
...
def run(self, keywords):
    ...
    print(f'\nFinding PubMed article URLs for {len(search_keywords)} keywords\n')
